function getCLEPCreditData() {
    ...
    let CLEPCreditData = {
        credits: [
            // 3s
            new CLEPCredit("French Language","French Language: Level 1", 50, "3 SCH free electives"),
            new CLEPCredit("Studio Art-2D Design","AP Studio Art 2D", 3, "3 SCH free electives"),
            new CLEPCredit("Studio Art-Drawing","AP Studio Art Drawing", 3, "3 SCH free electives"),
            new CLEPCredit("3D Art and Design","AP 3D and Design", 3, "ARTS 2381"),
            new CLEPCredit("Biology","AP Biology", 3, "3 SCH free electives"),
            new CLEPCredit("Chemistry","AP Chemistry", 3, "3 SCH free electives"),
            new CLEPCredit("Chinese","AP Chinese Lang and Culture", 3, "CHIN 1311 & 1312"),
            new CLEPCredit("Comp Sci","AP CSA", 3, "3 SCH free electives"),
            new CLEPCredit("Economics","AP MacroEconomics", 3, "3 SCH free electives"),
            new CLEPCredit("Economics","AP MicroEconomics", 3, "3 SCH free electives"),
